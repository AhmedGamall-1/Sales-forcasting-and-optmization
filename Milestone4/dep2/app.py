...
st.line_chart(df[['Date', 'Price ($)']].set_index('Date').tail(2000))
...
fig = go.Figure()
fig.add_trace(go.Scatter(x=df['Date'].tail(2000), y=df['Price ($)'].tail(2000), mode='lines+markers', name='Historical'))
